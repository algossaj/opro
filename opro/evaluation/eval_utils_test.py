...
class UtilsTest(parameterized.TestCase):
  ...
  @parameterized.named_parameters(
      ("accuracy_of_symbol_without_brackets_correct", "(A)", "a", "", 0),
      ("accuracy_of_symbol_without_brackets_wrong", "(A)", "b", "", 1),
      ("accuracy_of_symbol_with_brackets_correct", "(A)", "(a)", "", 0),
      ("accuracy_of_symbol_with_brackets_wrong", "(A)", "(b)", "", 1),
      (
